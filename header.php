...
<head>
  ...
  <style>
    ...
    /* Clean hero section — ONLY ONE background */
    .hero {
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="vehicle_listing.php">Vehicle Listing</a>
        </li>
        <li class="nav-item">
...
<div class="hero">
  ...
  <h4 class="fs-6 text-center">We believe your rental car should enhance your trip, not just be a part of it.</h4>
</div>
